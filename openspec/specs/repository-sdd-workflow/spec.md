# repository-sdd-workflow Specification

## Purpose

Define the repository-wide OpenSpec workflow, Codex integration, instruction sources, and validation gate for future changes.
## Requirements
